...
@Component({
  selector: 'app-edit-inviernos',
  templateUrl: './edit-inviernos.page.html',
  styleUrls: ['./edit-inviernos.page.scss'],
})
export class EditInviernosPage implements OnInit {
  riesgo = {} as Riesgo;
  id: any;
  ...
  async updateRiesgo(riesgo: Riesgo) {
    if (this.formValidation()) {
      ...
      try {
        await this.firestore.doc("inviernos/" + this.id).update(riesgo);
      } catch (e) {
        this.showToast(e);
      }

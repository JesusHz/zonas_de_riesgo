...
@Component({
  selector: 'app-add-fracturas',
  templateUrl: './add-fracturas.page.html',
  styleUrls: ['./add-fracturas.page.scss'],
})
export class AddFracturasPage implements OnInit {
  riesgo = {} as Riesgo;
  ...
  async createRiesgo(riesgo: Riesgo) {
    ...
    if (this.formValidation()) {
      ...
      try {
        await this.firestore.collection("fracturas").add(riesgo);
      } catch (e) {
        this.showToast(e);
      }

...
@Component({
  selector: 'app-edit-mas-extensos',
  templateUrl: './edit-mas-extensos.page.html',
  styleUrls: ['./edit-mas-extensos.page.scss'],
})
export class EditMasExtensosPage implements OnInit {
  extenso = {} as Extenso;
  id: any;
  ...
  async updateExtenso(extenso: Extenso) {
    if (this.formValidation()) {
      ...
      try {
        await this.firestore.doc("mas-extensos/" + this.id).update(extenso);
      } catch (e) {
        this.showToast(e);
      }

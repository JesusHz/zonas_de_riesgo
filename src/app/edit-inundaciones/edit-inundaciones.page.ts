...
@Component({
  selector: 'app-edit-inundaciones',
  templateUrl: './edit-inundaciones.page.html',
  styleUrls: ['./edit-inundaciones.page.scss'],
})
export class EditInundacionesPage implements OnInit {
  riesgo = {} as Riesgo;
  id: any;
  ...
  async updateRiesgo(riesgo: Riesgo) {
    if (this.formValidation()) {
      ...
      try {
        await this.firestore.doc("inundaciones/" + this.id).update(riesgo);
      } catch (e) {
        this.showToast(e);
      }
      ...
      this.navCtrl.navigateRoot("inundaciones");
    }
  }

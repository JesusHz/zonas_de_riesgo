...
@Component({
  selector: 'app-edit-desplazamientos',
  templateUrl: './edit-desplazamientos.page.html',
  styleUrls: ['./edit-desplazamientos.page.scss'],
})
export class EditDesplazamientosPage implements OnInit {
  riesgo = {} as Riesgo;
  id: any;
  ...
  async updateRiesgo(riesgo: Riesgo) {
    if (this.formValidation()) {
      ...
      try {
        await this.firestore.doc("desplazamientos/" + this.id).update(riesgo);
      } catch (e) {
        this.showToast(e);
      }
